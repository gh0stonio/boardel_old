  ...
  const daysNumber = useMemo(
    () =>
      weekDays.map(day => {
        ...
        return (
          <DaysNumberItem key={number} active={day.isSame(today, 'day')}>
            {number}
          </DaysNumberItem>
        )
      }),
  ...
  return (
    <Container>
      <Top>
        ...
        <CurrentMonth>{today.format('MMMM')}</CurrentMonth>

        <TodayCalendar viewBox="0 0 100 125" width="2rem" height="2rem">
